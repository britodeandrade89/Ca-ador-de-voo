        ...
        itinerary: [
             {
                ...
                days: [
                    ...
                    { day: 2, title: "Charme de Trancoso", activities: ["Passeio de dia inteiro para Trancoso.", "Explorar o Quadrado, a igreja de São João Batista e as praias dos Coqueiros e Nativos."]},
                    { day: 3, title: "Paraíso em Arraial d'Ajuda", activities: ["Passeio de dia inteiro para Arraial d'Ajuda.", "Caminhar pela charmosa Rua do Mucugê, relaxar na Praia do Mucugê ou Pitinga.", "Visitar o Eco Parque Arraial d'Ajuda (opcional)."]},
                    { day: 4, title: "Manhã Livre e Voo de Volta", activities: ["Manhã livre para um último mergulho ou compras.", "Check-out do hotel e deslocamento para o aeroporto para o voo da tarde."]}
                ]
            }
        ],
        accommodations: [
            ...
            itinerary: [
                {
                    ...
                    duration: "3 Dias",
                    days: [
                        { day: 1, title: "Chegada", activities: ["Atividade de exemplo 1.", "Atividade de exemplo 2."]},
                        { day: 2, title: "Exploração", activities: ["Atividade de exemplo 3.", "Atividade de exemplo 4."]},
                        { day: 3, title: "Despedida", activities: ["Atividade de exemplo 5."]}
                    ]
                }
            ]
        }
